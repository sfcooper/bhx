...
<?php include ("includes/menu.php"); ?>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-3">Travel Tips</h1>
...
<p>We've only just started adding tips to the website so it would be great to hear from you as to what you what tips and advice you'd like to see in the future. Feel free to add comments below to give us feedback. Thanks!</p>
