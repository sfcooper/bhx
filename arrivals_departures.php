...
<?php include ("includes/menu.php"); ?>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-3">Arrivals &amp; Departures</h1>
...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
      <div class="card-block">
      <iframe src="http://www.flightstats.com/go/weblet?guid=34b64945a69b9cac:28fe44e:122331428e5:-71d3&weblet=status&action=AirportFlightStatus&airportCode=BHX&airportQueryType=0" frameborder="0" scrolling="auto" width="auto" height=620px></iframe>
			<table width="480">
			  <tr>
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="card-block">
        <iframe src="http://www.flightstats.com/go/weblet?guid=34b64945a69b9cac:28fe44e:122331428e5:-71d3&weblet=status&action=AirportFlightStatus&airportCode=BHX&airportQueryType=1" frameborder="0" scrolling="auto" width="auto" height=620px></iframe>
			<table width="480">
			  <tr>
			    <td width="65%" style="font-family: Arial, sans-serif; font-size: 7pt;">
						 Flight information is provided by <a target="_blank" href="http://www.flightstats.com">FlightStats</a>, and is subject to the FlightStats <a target="_blank" href="http://www.flightstats.com/go/About/termsOfUse.do">Terms of Use</a>.
