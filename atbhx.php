...
<!-- End Google Tag Manager -->
	  <title>Birmingham International Airport</title>
	  	  <!--Pushcrew Sript--><script type="text/javascript">
    (function(p,u,s,h){
        p._pcq=p._pcq||[];
  ...
  <?php include ("./includes/menu.php"); ?>
       <div class="jumbotron">
      <div class="container">
        <h1 class="display-3">At The Airport</h1>
...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <div class="col-md-9"><h2 class="display-4">Airport Facilities</h2>
...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <p>There are three airport lounges at Birmingham Airport.</p>
		<ul>
		<li>Emirates</li>
		<li>No.1 Lounge</li>
