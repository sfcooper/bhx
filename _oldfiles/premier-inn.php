...
<meta name="description" content="Premier Inn at Birmingham Airport. Details, reviews and rates." />
...
$(document).ready(function(){
    ...
    "term=premier%20inn%20bickenhill"+
    "&location=B26%203QJ"+
...
<h1>Premier Inn - Birmingham Airport</h1>
...
<H2>Hotel Description</H2>
      ...
      <div id="leftpic"></div>
	  <p>The Premier Inn is very well placed for both Birmingham International Airport and also the National Exhibition Centre (NEC).  This is a good value chain hotel with complimentary one-way taxi service to the airport.</p>
<br />
<br />
...
<H2>Hotel Reviews</H2>
      ...
      <div id="review"></div>
	  <p>If you have stayed at the Premier Inn at Birmingham Airport, why not add your own review at <a href="http://www.yelp.co.uk/biz/premier-inn-bickenhill">yelp.com</a></p>
	  <a href="http://yelp.com"><img src="/images/reviewsFromYelpRED.gif" alt="Reviews from Yelp" border="0" /></a>

<H2>Rates and Offers</H2>
      <a href="http://www.premierinn.com/en/hotel/BIRPLI/birmingham-nec-airport">Check prices and availability</a>
